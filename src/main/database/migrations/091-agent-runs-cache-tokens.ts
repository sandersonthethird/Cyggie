...
export function runAgentRunsCacheTokensMigration(db: Database.Database): void {
  db.exec(`
    ALTER TABLE agent_runs ADD COLUMN cache_read_input_tokens_total INTEGER NOT NULL DEFAULT 0;
    ALTER TABLE agent_runs ADD COLUMN cache_creation_input_tokens_total INTEGER NOT NULL DEFAULT 0;
  `)
}
