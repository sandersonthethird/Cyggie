...
const CONTACT_FIELDS: FieldDef[] = [
  ...
  { value: 'city_state', label: 'City + State (combined, e.g. "New York, NY")' },
  ...
  { value: 'investment_sector_focus_notes', label: 'Investment Sector Focus Notes' },
  { value: 'street', label: 'Street' },
  { value: 'postal_code', label: 'Postal Code' },
  { value: 'country', label: 'Country' },
  { value: 'other_socials', label: 'Other Socials' },
  ...
  { value: 'linkedin_skills', label: 'LinkedIn Skills' },
]
...
const COMPANY_FIELDS: FieldDef[] = [
  ...
  { value: 'product_stage', label: 'Product Stage' },
  { value: 'revenue_model', label: 'Revenue Model' },
  { value: 'target_investment_stage', label: 'Target Investment Stage' },
  { value: 'target_investment_sector', label: 'Target Investment Sector' },
  { value: 'angellist_url', label: 'AngelList URL' },
  { value: 'portfolio_fund', label: 'Portfolio Fund' },
  { value: 'lead_investor', label: 'Lead Investor' },
  { value: 'relationship_owner', label: 'Relationship Owner' },
  { value: 'warm_intro_source', label: 'Warm Intro Source' },
  { value: 'key_takeaways', label: 'Key Takeaways (Notes)' },
  { value: 'post_money_valuation', label: 'Post-Money Valuation' },
  { value: 'raise_size', label: 'Raise Size' },
  { value: 'last_company_valuation', label: 'Last Company Valuation' },
  { value: 'investment_size', label: 'Investment Size' },
  { value: 'ownership_pct', label: 'Ownership %' },
  { value: 'total_invested', label: 'Total Invested' },
  { value: 'investment_mark', label: 'Investment Mark' },
  { value: 'investment_round', label: 'Investment Round' },
  { value: 'initial_investment_security', label: 'Initial Investment Security' },
  { value: 'date_of_initial_investment', label: 'Date of Initial Investment' },
  { value: 'initial_round_size', label: 'Initial Round Size' },
  { value: 'followon_investment_size', label: 'Follow-on Investment Size' },
  { value: 'followon_check', label: 'Follow-on Check' },
  { value: 'followon_date', label: 'Follow-on Date' },
  { value: 'followon_check_2', label: 'Follow-on Check 2' },
  { value: 'followon_date_2', label: 'Follow-on Date 2' },
]
