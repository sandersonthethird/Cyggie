        ...
        {isEditing ? (
          <div className={styles.metaEditBlock}>
            ...
            <div className={styles.metaRow}>
              ...
              <input
                className={styles.metaInput}
                value={emailDraft2}
                onChange={(e) => setEmailDraft2(e.target.value)}
                placeholder="Email 2 (alternate)"
                onKeyDown={(e) => { if (e.key === 'Enter') (e.target as HTMLInputElement).blur() }}
              />
            </div>
            <div className={styles.metaRow}>
          ...
          <>
            ...
            {contact.emails[1] && (
              <div
                className={`${styles.metaRow} ${styles.metaRowCopyable}`}
                onClick={() => copyMeta(contact.emails[1]!, 'email2')}
                title="Click to copy"
              >
                <span className={styles.metaIcon}>✉</span>
                <span className={styles.metaValue}>{contact.emails[1]}</span>
                {copiedMeta === 'email2' && <span className={styles.copiedToast}>Copied!</span>}
              </div>
            )}
            {contact.linkedinUrl && (
              <div className={styles.metaRow}>
